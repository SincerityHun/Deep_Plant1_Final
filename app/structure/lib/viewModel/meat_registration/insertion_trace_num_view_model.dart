  ...
  Future<void> fetchData(String historyNo) async {
    ...
    if (traceNum!.startsWith('0')) {
      try {
        ...
        birthYmd = DateFormat('yyyyMMdd').format(DateTime.parse(date!)).toString(); // 날짜 형식을 yyyyMMdd로 변경
        ...
        butcheryYmd = DateFormat('yyyyMMdd').format(DateTime.parse(butDate!)).toString(); // 날짜 형식을 yyyyMMdd로 변경
      ...
      try {
        ...
        butcheryYmd = DateFormat('yyyyMMdd').format(DateTime.parse(time!)).toString(); // 날짜 형식을 yyyyMMdd로 변경
