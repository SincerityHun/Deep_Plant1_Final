      ...
      body: Stack(
        children: [
              ...
              child: Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      'QR코드 스캔',
                      style: TextStyle(fontSize: 34.sp, fontWeight: FontWeight.w600, color: Colors.white),
                    ),
                  ),
                  IconButton(
                    // QR 페이지에서 나간다.
          ...
          Positioned(
            ...
            bottom: (MediaQuery.of(context).size.height - MediaQuery.of(context).padding.top) * 0.2,
            left: 0,
            right: 0,
            child: InkWell(
