...
class MeatModel with ChangeNotifier {
  ...
  void fromJson(Map<String, dynamic> jsonData) {
    ...
    processedmeatDataComplete = jsonData['processedmeat_data_complete'] == false ? {} : jsonData['processedmeat_data_complete'];
  ...
  void fromJsonAdditional(String deepAgingNum) {
    ...
    if (probexptData?['sourness'] != null && probexptData?['bitterness'] != null && probexptData?['umami'] != null && probexptData?['richness'] != null) {
