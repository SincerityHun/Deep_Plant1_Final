          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                CustomIconButton(
                  ...
                  onTap: () => context.read<HomeViewModel>().clickedMyPage(context),
                  width: 80.w,
                  height: 80.h,
                ),
              ],
            ...
            Row(
              children: [
                // 육류 등록 버튼
                InkWell(
                  onTap: () => context.read<HomeViewModel>().clickedMeatRegist(context),
                  child: HomeCard(
                    mainText: '육류등록',
                    subText: '육류 정보를 입력하고\n데이터를 전송합니다',
                ...
                const Spacer(),
                InkWell(
                  onTap: () => context.read<HomeViewModel>().clickedDataManage(context),
                  child: HomeCard(
                    mainText: '데이터 관리',
                    subText: '등록된 데이터를\n열람/수정합니다',
    ...
    return Stack(
      children: [
        Container(
          width: 300.w,
          height: 538.h,
          decoration: BoxDecoration(color: mainColor, borderRadius: BorderRadius.all(Radius.circular(150.sp))),
        ...
        Transform.translate(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(color: btnColor, borderRadius: BorderRadius.all(Radius.circular(50.sp))),
            child: Icon(
              Icons.arrow_forward,
              size: 50.w,
              color: Colors.white,
