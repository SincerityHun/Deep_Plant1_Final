          ...
          child: Column(
            children: [
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      if (context.watch<AddDeepAgingDataViewModel>().isSelectedDate)
                        CustomTableCalendar(
                            focusedDay: context.watch<AddDeepAgingDataViewModel>().focused,
                            selectedDay: context.watch<AddDeepAgingDataViewModel>().selected,
                            onDaySelected: (selectedDay, focusedDay) => context.read<AddDeepAgingDataViewModel>().onDaySelected(selectedDay, focusedDay)),
                        ...
                        children: [
                          Expanded(
                            ...
                            child: MainTextField(
                              validateFunc: null,
                              onSaveFunc: null,
                              onChangeFunc: (value) => context.read<AddDeepAgingDataViewModel>().changeState(value!),
                              mainText: '',
                              width: 229.w,
                              height: 88.h,
                              canAlert: false,
                              controller: context.read<AddDeepAgingDataViewModel>().textEditingController,
              ...
              MainButton(
                ...
                width: 658.w,
                height: 104.h,
                onPressed: context.watch<AddDeepAgingDataViewModel>().isInsertedMinute
                    ? () async => context.read<AddDeepAgingDataViewModel>().saveData(context)
                    : null,
              ),
            ],
          ),
