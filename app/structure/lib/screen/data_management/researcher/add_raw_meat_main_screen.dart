      ...
      body: Center(
        child: Column(
          children: [
            ...
            InkWell(
              onTap: () => context.read<AddRawMeatViewModel>().clickedHeated(context),
              child: StepCard(
                mainText: '가열육 관능평가',
            ...
            InkWell(
              onTap: () => context.read<AddRawMeatViewModel>().clickedTongue(context),
              child: StepCard(
                mainText: '전자혀 데이터',
            ...
            InkWell(
              onTap: () => context.read<AddRawMeatViewModel>().clickedLab(context),
              child: StepCard(
                mainText: '실험 데이터',
