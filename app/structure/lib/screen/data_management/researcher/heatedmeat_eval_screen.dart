      ...
      body: SingleChildScrollView(
        child: Stack(
          children: [
            Column(
              ...
              children: [
                ...
                PartEval(
                  ...
                  onChanged: (value) => context.read<HeatedMeatEvalViewModel>().onChangedFlavor(value),
                ),
                SizedBox(
                  height: 50.h,
                ),
                PartEval(
                  ...
                  onChanged: (value) => context.read<HeatedMeatEvalViewModel>().onChangedJuiciness(value),
                ),
                SizedBox(
                  height: 50.h,
                ),
                PartEval(
                  ...
                  onChanged: (value) => context.read<HeatedMeatEvalViewModel>().onChangedTenderness(value),
                ),
                SizedBox(
                  height: 50.h,
                ),
                PartEval(
                  ...
                  onChanged: (value) => context.read<HeatedMeatEvalViewModel>().onChangedUmami(value),
                ),
                SizedBox(
                  height: 50.h,
                ),
                PartEval(
                  ...
                  onChanged: (value) => context.read<HeatedMeatEvalViewModel>().onChangedPalatability(value),
                ),
                SizedBox(
                  height: 120.h,
                ),
                ...
                Container(
                  ...
                  child: MainButton(
                    onPressed: context.watch<HeatedMeatEvalViewModel>().completed ? () => context.read<HeatedMeatEvalViewModel>().saveData(context) : null,
                    text: '저장',
                    width: 658.w,
                    height: 104.h,
                    mode: 1,
            ...
            context.watch<HeatedMeatEvalViewModel>().isLoading ? const CircularProgressIndicator() : Container()
          ],
        ),
      ),
    );
