...
class AddProcessedMeatMainScreen extends StatefulWidget {
  ...
  @override
  State<AddProcessedMeatMainScreen> createState() => _AddProcessedMeatMainScreenState();
}

class _AddProcessedMeatMainScreenState extends State<AddProcessedMeatMainScreen> {
  @override
      ...
      body: Center(
        child: Column(
          children: [
            ...
            InkWell(
              onTap: () => context.read<AddProcessedMeatViewModel>().clickedImage(context),
              child: StepCard(
                mainText: '처리육 단면 촬영',
            ...
            InkWell(
              onTap: () => widget.meatModel.deepAgedImageCompleted ? context.read<AddProcessedMeatViewModel>().clickedProcessedEval(context) : null,
              child: StepCard(
                mainText: '처리육 관능평가',
            ...
            InkWell(
              onTap: () => context.read<AddProcessedMeatViewModel>().clickedHeatedEval(context),
              child: StepCard(
                mainText: '가열육 관능평가',
            ...
            InkWell(
              onTap: () => context.read<AddProcessedMeatViewModel>().clickedTongue(context),
              child: StepCard(
                mainText: '전자혀 데이터',
            ...
            InkWell(
              onTap: () => context.read<AddProcessedMeatViewModel>().clickedLab(context),
              child: StepCard(
                mainText: '실험 데이터',
