                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              Text(
                                context.watch<DataManagementHomeResearcherViewModel>().filterdResult,
                                style: Palette.h4,
                              ),
                      ...
                      builder: (context, viewModel, child) => InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: viewModel.dateStatus[3] ? Palette.fieldEmptyBg : Palette.dataMngCardBg,
                          ...
                          child: Text(
                            ...
                            style: viewModel.dateStatus[3] ? Palette.h5 : Palette.h5LightGrey,
                          ),
                        ),
                      ),
                    ),
        ...
        (index) => InkWell(
          ...
          child: Container(
            ...
            child: Text(
              filterList[index],
              style: TextStyle(
                color: status[index] ? Palette.editableBg : Palette.waitingCardBg,
              ),
            ),
          ),
        ),
