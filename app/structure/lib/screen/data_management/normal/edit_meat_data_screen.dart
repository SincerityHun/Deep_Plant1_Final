...
class EditMeatDataScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(title: '${context.read<EditMeatDataViewModel>().meatModel.id}', backButton: true, closeButton: false),
      body: Center(
        child: Column(
          children: [
            SizedBox(
            ...
            InkWell(
              onTap: () => context.read<EditMeatDataViewModel>().clicekdBasic(context),
              child: StepCard2(
                mainText: '육류 기본정보',
            ...
            InkWell(
              onTap: () => context.read<EditMeatDataViewModel>().clickedImage(context),
              child: StepCard2(
                mainText: '육류 단면 촬영',
                isEditable: context.read<EditMeatDataViewModel>().isEditable,
            ...
            InkWell(
              onTap: () => context.read<EditMeatDataViewModel>().clicekdFresh(context),
              child: StepCard2(
                mainText: '신선육 관능평가',
                isEditable: context.read<EditMeatDataViewModel>().isEditable,
