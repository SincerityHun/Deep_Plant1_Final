...
class InsertionTraceNumNotEditableScreen extends StatefulWidget {
  ...
  @override
  State<InsertionTraceNumNotEditableScreen> createState() => _InsertionTraceNumNotEditableScreenState();
}

class _InsertionTraceNumNotEditableScreenState extends State<InsertionTraceNumNotEditableScreen> {
  @override
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            if (context.watch<InsertionTraceNumNotEditableViewModel>().isAllInserted == 1)
              Expanded(child: ListTable(tableData: context.read<InsertionTraceNumNotEditableViewModel>().tableData))
            else if (context.read<InsertionTraceNumNotEditableViewModel>().isAllInserted == 2)
              const Expanded(
                child: Center(
                  child: Padding(
            ...
            else if (context.read<InsertionTraceNumNotEditableViewModel>().isAllInserted == 0)
              const Spacer(
                flex: 2,
              ),
            Container(
              ...
              child: MainButton(
                ...
                width: 658.w,
                height: 104.h,
                onPressed: () => context.read<InsertionTraceNumNotEditableViewModel>().clickedNextButton(context),
              ),
            ),
          ],
        ),
