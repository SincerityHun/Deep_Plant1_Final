          ...
          Column(
            ...
            children: [
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            context.watch<InsertionMeatImageNotEditableViewModel>().date,
                            style: Palette.h4,
                          ),
                        ),
                      ),
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.only(left: 10.0),
                          child: Text(
                            context.watch<InsertionMeatImageNotEditableViewModel>().userName,
                            style: Palette.h5,
                          ),
                        ),
                      ),
              ...
              Column(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    height: 653.h,
                    child: Image.network(
                      context.read<InsertionMeatImageNotEditableViewModel>().imagePath!,
              ...
              Container(
                ...
                child: MainButton(
                  onPressed: () {
                    context.read<InsertionMeatImageNotEditableViewModel>().clickedNextButton(context);
                  },
                  text: '완료',
                  width: 640.w,
                  height: 96.h,
