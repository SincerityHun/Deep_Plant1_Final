...
class FreshMeatEvalNotEditableScreen extends StatefulWidget {
  ...
  @override
  State<FreshMeatEvalNotEditableScreen> createState() => _FreshMeatEvalNotEditableScreenState();
}

class _FreshMeatEvalNotEditableScreenState extends State<FreshMeatEvalNotEditableScreen> with SingleTickerProviderStateMixin {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Icon(
                    Icons.check,
                    color: context.watch<FreshMeatEvalNotEditableViewModel>().marbling > 0 ? Palette.mainButtonColor : Colors.transparent,
                  ),
                  const Spacer(),
                  Icon(
                    Icons.check,
                    color: context.watch<FreshMeatEvalNotEditableViewModel>().color > 0 ? Palette.mainButtonColor : Colors.transparent,
                  ),
                  const Spacer(),
                  Icon(
                    Icons.check,
                    color: context.watch<FreshMeatEvalNotEditableViewModel>().texture > 0 ? Palette.mainButtonColor : Colors.transparent,
                  ),
                  const Spacer(),
                  Icon(
                    Icons.check,
                    color: context.watch<FreshMeatEvalNotEditableViewModel>().surface > 0 ? Palette.mainButtonColor : Colors.transparent,
                  ),
                  const Spacer(),
                  Icon(
                    Icons.check,
                    color: context.watch<FreshMeatEvalNotEditableViewModel>().overall > 0 ? Palette.mainButtonColor : Colors.transparent,
                  ),
                  SizedBox(
                    width: 70.w,
                  ),
