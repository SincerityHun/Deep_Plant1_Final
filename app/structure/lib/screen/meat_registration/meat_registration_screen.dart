        ...
        child: context.watch<MeatRegistrationViewModel>().isLoading
            ...
            : Column(
                children: [
                  ...
                  // STEP 1 : 육류 기본정보 등록
                  InkWell(
                    onTap: () => context.read<MeatRegistrationViewModel>().clickedBasic(context),
                    child: StepCard(
                      mainText: '육류 기본정보',
                  ...
                  // STEP 2 : 육류 단면 촬영
                  InkWell(
                      onTap: () => widget.meatModel.basicCompleted ? context.read<MeatRegistrationViewModel>().clickedImage(context) : null,
                      child: StepCard(
                        mainText: '육류 단면 촬영',
                  ...
                  // STEP 3 : 신선육 관능평가
                  InkWell(
                      onTap: () => widget.meatModel.freshImageCompleted ? context.read<MeatRegistrationViewModel>().clickedFreshmeat(context) : null,
                      child: StepCard(
                        mainText: '신선육 관능평가',
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed:
                                widget.meatModel.basicCompleted ? () async => context.read<MeatRegistrationViewModel>().clickedTempSaveButton(context) : null,
                        ...
                        SizedBox(
                          ...
                          height: 104.h,
                          child: ElevatedButton(
                            onPressed: widget.meatModel.basicCompleted && widget.meatModel.freshImageCompleted && widget.meatModel.rawFreshCompleted
                                ? () => context.read<MeatRegistrationViewModel>().clickedSaveButton(context)
                                : null,
                            style: ElevatedButton.styleFrom(
                                disabledBackgroundColor: Palette.notEditableBg,
                                backgroundColor: Palette.mainBtnAtvBg,
