...
class _FreshMeatEvalScreenState extends State<FreshMeatEvalScreen> with SingleTickerProviderStateMixin {
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                ...
                height: 600.h,
                // 관능평가를 위한 이미지 할당.
                child: context.read<FreshMeatEvalViewModel>().meatImage.contains('http')
                    ? Image.network(
              ...
              Row(
                ...
                children: [
                  ...
                  Icon(
                    Icons.check,
                    color: context.watch<FreshMeatEvalViewModel>().marbling > 0 ? Palette.meatRegiBtnBg : Colors.transparent,
                  ),
                  const Spacer(),
                  Icon(
                    Icons.check,
                    color: context.watch<FreshMeatEvalViewModel>().color > 0 ? Palette.meatRegiBtnBg : Colors.transparent,
                  ),
                  const Spacer(),
                  Icon(
                    Icons.check,
                    color: context.watch<FreshMeatEvalViewModel>().texture > 0 ? Palette.meatRegiBtnBg : Colors.transparent,
                  ),
                  const Spacer(),
                  Icon(
                    Icons.check,
                    color: context.watch<FreshMeatEvalViewModel>().surface > 0 ? Palette.meatRegiBtnBg : Colors.transparent,
                  ),
                  const Spacer(),
                  Icon(
                    Icons.check,
                    color: context.watch<FreshMeatEvalViewModel>().overall > 0 ? Palette.meatRegiBtnBg : Colors.transparent,
                  ),
                  SizedBox(
                    width: 70.w,
                  ),
                    ...
                    children: [
                      ...
                      Center(
                        child: PartEval(
                          ...
                          onChanged: (value) => viewModel.onChangedMarbling(value),
                        ),
                      ),
                      // 육색
                      Center(
                      ...
                      Center(
                        child: PartEval(
                          ...
                          onChanged: (value) => viewModel.onChangedTexture(value),
                        ),
                      ),
                      // 육즙
                      Center(
                        child: PartEval(
                          ...
                          onChanged: (value) => viewModel.onChangedSurface(value),
                        ),
                      ),
                      // 기호도
                      Center(
                        child: PartEval(
                          ...
                          onChanged: (value) => viewModel.onChangedOverall(value),
                        ),
                      ),
                    ],
                  ),
              ...
              Container(
                ...
                child: MainButton(
                  onPressed:
                      context.watch<FreshMeatEvalViewModel>().completed ? () async => context.read<FreshMeatEvalViewModel>().saveMeatData(context) : null,
                  text: '저장',
                  width: 658.w,
                  height: 104.h,
                  mode: 1,
