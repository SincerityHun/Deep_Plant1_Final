        ...
        body: Column(
          children: [
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      ToggleButtons(
                        isSelected: context.watch<InsertionMeatInfoViewModel>().selectedSpecies,
                        ...
                        onPressed: (index) {},
                        children: context.read<InsertionMeatInfoViewModel>().speciesValues,
                      ),
                    ],
                  ),
                  SizedBox(
                  ...
                  CustomDropdown(
                    ...
                    value: context.watch<InsertionMeatInfoViewModel>().primalValue,
                    itemList: context.read<InsertionMeatInfoViewModel>().largeDiv,
                    onChanged: context.watch<InsertionMeatInfoViewModel>().isSelectedSpecies
                        ? (value) {
                  ...
                  CustomDropdown(
                    ...
                    value: context.watch<InsertionMeatInfoViewModel>().secondaryValue,
                    itemList: context.watch<InsertionMeatInfoViewModel>().litteDiv,
                    onChanged: context.watch<InsertionMeatInfoViewModel>().isSelectedPrimal
                        ? (value) {
                            context.read<InsertionMeatInfoViewModel>().secondaryValue = value as String;
                            context.read<InsertionMeatInfoViewModel>().setSecondary();
                          }
                        : null,
                  ),
                ],
            ...
            Container(
              ...
              child: MainButton(
                onPressed:
                    context.watch<InsertionMeatInfoViewModel>().completed ? () => context.read<InsertionMeatInfoViewModel>().clickedNextButton(context) : null,
                text: context.read<InsertionMeatInfoViewModel>().meatModel.id == null ? '완료' : '수정사항 저장',
                width: 658.w,
                height: 104.h,
                mode: 1,
              ),
